...
<div class="app-content">
          ...
          <div class="row">
            <div class="col-12">
              <div class="slider-content slider-content--animation">
                ...
                <span class="content-span-2 u-c-white">10% Off On Bags</span>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-md-5 u-s-m-b-30">
            ...
            <router-link class="collection" to="/shop">
              <div class="aspect aspect--bg-grey aspect--square">

                <img class="aspect__img collection__img" src="https://cdn.shopify.com/s/files/1/0264/1903/6265/products/IMG-20210124-WA0069.jpg?v=1611803842" alt=""></div>
            </router-link></div>
          <div class="col-lg-7 col-md-7 u-s-m-b-30">
            ...
            <router-link class="collection" to="/shop">
              <div class="aspect aspect--bg-grey aspect--1286-890">
                ...
                <img class="aspect__img collection__img" src="https://i.etsystatic.com/20724925/r/il/c10008/2550628986/il_fullxfull.2550628986_ilb4.jpg" alt=""></div>
            </router-link></div>
          <div class="col-lg-7 col-md-7 u-s-m-b-30">
            ...
            <router-link class="collection" to="/shop">
              <div class="aspect aspect--bg-grey aspect--1286-890">
                ...
                <img class="aspect__img collection__img" src="https://d17a17kld06uk8.cloudfront.net/products/M551HN3/4FKLM4EC-large-r4TR97I.jpg" alt=""></div>
            </router-link></div>
          <div class="col-lg-5 col-md-5 u-s-m-b-30">
            ...
            <router-link class="collection" to="/shop">
              <div class="aspect aspect--bg-grey aspect--square">
                ...
                <img class="aspect__img collection__img" src="https://cdn.shopify.com/s/files/1/0036/0454/5605/products/6C7FB620-5DF3-4FEB-A470-532084992426_1445x.jpg?v=1639300926" alt=""></div>
            </router-link></div>
        </div>
      </div>
    </div>
  ...
  <div class="u-s-p-b-60">
    ...
    <div class="section__content">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 u-s-m-b-30" v-for="product in products.slice(0, 2)" :key="product.id">
            <div class="product-o product-o--radius product-o--hover-off u-h-100">
              <div class="product-o__wrap">

                <router-link class="aspect aspect--bg-grey aspect--square u-d-block" :to="`product/${product.id}`">

                  <img class="aspect__img" :src="product.image" :alt="product.title"></router-link>
                ...
                <div class="product-o__action-wrap">
                  <ul class="product-o__action-list">
                    ...
                    <li><router-link  to="/account" data-tooltip="tooltip" data-placement="top" title="Add to Wishlist"><i class="fas fa-heart"></i></router-link></li>
              ...
              <span class="product-o__category">
                                        ...
                                        <router-link :to="`product/${product.id}`">{{ product.category }}</router-link></span>

              <span class="product-o__name">

                                        <router-link :to="`product/${product.id}`">{{ product.title }}</router-link></span>
          ...
          <div class="col-lg-12">
            ...
            <div class="banner-bg__wrap">
              <div class="banner-bg__text-1">
                ...
                <span class="u-c-white text-red">Global</span>
              ...
              <router-link class="banner-bg__shop-now btn--e-secondary" to="/shop">Shop Now</router-link>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="u-s-p-b-90 u-s-m-b-30">
    ...
    <div class="section__content">
      <div class="container">
        ...
        <!--====== Testimonial Slider ======-->
        <div>
          <div class="owl-carousel testimonials" id="testimonial-slider">
